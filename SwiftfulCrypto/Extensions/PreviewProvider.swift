...
//  SwiftfulCrypto
//
//  Created by Shubham lahoti on 20/9/23.
//
...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$12.5Bn", percentageChange: 25.66)
    let stat2 = StatisticModel(title: "Total Volume", value: "$1.23Tr")
    let stat3 = StatisticModel(title: "Portfolio Value", value: "$50.9k", percentageChange: -12.34)
